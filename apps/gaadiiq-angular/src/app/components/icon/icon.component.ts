...
const ICONS: Record<string, string> = {
  ...
  'car': '<path d="M5 17H3a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h18a2 2 0 0 1 2 2v6a2 2 0 0 1-2 2h-2"/><path d="M14 17H10"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="16.5" cy="17.5" r="2.5"/><path d="m3 9 2-4h14l2 4"/>',
