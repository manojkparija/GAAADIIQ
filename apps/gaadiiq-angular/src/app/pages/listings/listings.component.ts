...
export class ListingsComponent {
  ...
  allCars: Car[] = [
    ...
    { id:18, make:'Hyundai', model:'Exter',        year:2024, price:699000,  km:3000,  fuel:'Petrol',   transmission:'AMT',       badge:'🆕 Nearly New',   badgeType:'badge-purple', image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/192315/exter-exterior-right-front-three-quarter-2.jpeg',           rating:4.5, reviews:156, verified:true, city:'Hyderabad', bodyType:'Hatchback' },
    ...
    { id:28, make:'Tata', model:'Tigor EV',        year:2024, price:1199000, km:4000,  fuel:'Electric', transmission:'Automatic', badge:'⚡ Electric',     badgeType:'badge-green',  image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/133490/tigor-ev-exterior-right-front-three-quarter-2.jpeg',        rating:4.5, reviews:134, verified:true, city:'Hyderabad', bodyType:'Sedan' },
    // Mahindra
    ...
    { id:33, make:'Mahindra', model:'XUV400 EV',   year:2024, price:1599000, km:3000,  fuel:'Electric', transmission:'Automatic', badge:'⚡ Electric',     badgeType:'badge-green',  image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/178825/xuv400-ev-exterior-right-front-three-quarter-2.jpeg',       rating:4.6, reviews:112, verified:true, city:'Chennai',   bodyType:'SUV' },
    ...
    { id:37, make:'Honda', model:'Elevate',        year:2024, price:1199000, km:4000,  fuel:'Petrol',   transmission:'CVT',       badge:'🆕 Nearly New',   badgeType:'badge-purple', image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/192337/elevate-exterior-right-front-three-quarter-2.jpeg',          rating:4.6, reviews:167, verified:true, city:'Mumbai',    bodyType:'SUV' },
    ...
    // Kia
    { id:46, make:'Kia', model:'Seltos',           year:2024, price:1099000, km:3000,  fuel:'Petrol',   transmission:'DCT',       badge:'🆕 Nearly New',   badgeType:'badge-purple', image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/115025/seltos-exterior-right-front-three-quarter-3.jpeg',          rating:4.8, reviews:201, verified:true, city:'Hyderabad', bodyType:'SUV' },
    ...
    { id:54, make:'MG Motor', model:'Comet EV',    year:2024, price:699000,  km:2000,  fuel:'Electric', transmission:'Automatic', badge:'⚡ City EV',      badgeType:'badge-green',  image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/191285/comet-ev-exterior-right-front-three-quarter-2.jpeg',        rating:4.3, reviews:112, verified:true, city:'Hyderabad', bodyType:'Hatchback' },
  ];
