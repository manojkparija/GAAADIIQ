...
export class ListingsComponent implements OnInit {
  ...
  allCars: Car[] = [
    ...
    // Mahindra XUV 3XO
    { id:55, make:'Mahindra', model:'XUV 3XO',       year:2024, price:749000,  km:0,     fuel:'Petrol',   transmission:'Manual',    badge:'🆕 Brand New',    badgeType:'badge-purple', image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/198343/xuv-3xo-exterior-right-front-three-quarter.jpeg',         rating:4.7, reviews:312, verified:true, city:'Delhi',     bodyType:'SUV' },
    { id:56, make:'Mahindra', model:'XUV 3XO',       year:2024, price:999000,  km:0,     fuel:'Petrol',   transmission:'Automatic', badge:'🔥 Trending',     badgeType:'badge-red',    image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/198343/xuv-3xo-exterior-right-front-three-quarter.jpeg',         rating:4.8, reviews:289, verified:true, city:'Mumbai',    bodyType:'SUV' },
    { id:57, make:'Mahindra', model:'XUV 3XO',       year:2024, price:1149000, km:0,     fuel:'Diesel',   transmission:'Manual',    badge:'💰 Best Value',   badgeType:'badge-gold',   image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/198343/xuv-3xo-exterior-right-front-three-quarter.jpeg',         rating:4.7, reviews:198, verified:true, city:'Bangalore', bodyType:'SUV' },
    { id:58, make:'Mahindra', model:'XUV 3XO',       year:2024, price:1349000, km:0,     fuel:'Diesel',   transmission:'Automatic', badge:'⭐ Top Rated',    badgeType:'badge-gold',   image:'https://imgd.aeplcdn.com/1200x900/n/cw/ec/198343/xuv-3xo-exterior-right-front-three-quarter.jpeg',         rating:4.9, reviews:156, verified:true, city:'Hyderabad', bodyType:'SUV' },
    // MG Motor
