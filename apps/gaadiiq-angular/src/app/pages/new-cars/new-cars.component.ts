...
export class NewCarsComponent implements OnInit {
  ...
  brands = [
    { name: 'Tata', icon: '🚗' }, { name: 'Maruti Suzuki', icon: '🚙' },
    { name: 'Mahindra', icon: '🏔️' }, { name: 'Hyundai', icon: '🚘' },
    { name: 'Toyota', icon: '🚐' }, { name: 'Kia', icon: '🛻' },
    { name: 'BMW', icon: '💎' }, { name: 'Skoda', icon: '🔵' },
    { name: 'MG', icon: '⚡' }, { name: 'Renault', icon: '🔶' },
    { name: 'Volkswagen', icon: '🔷' }, { name: 'Mercedes', icon: '⭐' },
    { name: 'Honda', icon: '🔴' }, { name: 'Audi', icon: '🔘' },
    { name: 'Nissan', icon: '🟦' }, { name: 'Jeep', icon: '🟩' },
  ];
